...
const PostMenuActions = ({ post }) => {
    ...
    return (
        <div>
            ...
            {isPending ? "Loading..." : error ? "Saved posts fetching failed!" : <div className="flex items-center gap-2 py-2 text-sm cursor-pointer" onClick={handleSave}>
                <svg
                ...
                >
                    <path
                        ...
                        stroke="black"
                        strokeWidth="2"
                        fill={saveMutation.isPending ? isSaved ? "none" : "black" : isSaved ? "black" : "transparent"}
                    />
                </svg>
                <span>
