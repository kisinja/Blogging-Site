    ...
    return (
        <div className="mt-4 flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between">
                {/* titles */}
                <div className="">
                    <h1 className="text-gray-800 text-2xl md:text-5xl lg:text-6xl font-bold">Explore Ideas, Trends, and Insights with Elvislog</h1>
                    <p className="mt-8 text-md md:text-lg">
                        Discover engaging content, fresh perspectives, and inspiring stories on Elvislog.
                    </p>
                </div>
                {/* animated button */}
